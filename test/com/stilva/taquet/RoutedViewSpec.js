...
RoutedView = Taquet.RoutedView.extend({
  route: "name",
  show: function() {
    "use strict";
    console.log("hello----!!");
...
$(function(){
  ...
  var a = new Router(),
      b = new View(),
      c = new RoutedView({route:["nope", "double-nope"]});
  ...
  describe("RoutedView", function() {
    it("", function() {
      console.log("RoutedView::");
