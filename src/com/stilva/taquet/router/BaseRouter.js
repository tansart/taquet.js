(function(parent, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define([
      ...
      'com/stilva/util/Queue',
      'underscore',
      'backbone'
    ], function(BaseEvent, Queue, _, Backbone) {
      return factory(BaseEvent, Queue, _, Backbone);
    });
  } else {
    // Browser globals
    parent.BaseRouter = factory(parent.BaseEvent, parent.Queue, parent._, parent.Backbone);
  }
}(this, function(BaseEvent, Queue, _, Backbone) {
  "use strict";
